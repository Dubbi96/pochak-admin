...
const KAKAO_REST_KEY = 'edc9e6bd81a7a4acf582dc0b5abe7a18';
const GOOGLE_CLIENT_ID = '314211860010-54tasp17q8b5qfq8648vu0jl4v3v5ojb.apps.googleusercontent.com';
...
function buildOAuthUrl(provider: 'kakao' | 'google' | 'naver'): string {
  ...
  switch (provider) {
    ...
    case 'naver':
      return `https://nid.naver.com/oauth2.0/authorize?client_id=MRf6icYP1IOnUr_RxdB_&redirect_uri=${redirectUri}&response_type=code&state=${state}`;
    default:
      return '#';
  }
}

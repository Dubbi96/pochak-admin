...
// Pochak OTT Platform - Phone Verification Screen
// Design ref: [포착3.0] Mobile 디자인 - 연락처 본인 인증
...
struct PhoneVerificationView: View {
    ...
    private var phoneInputRow: some View {
        HStack(spacing: 8) {
            ...
            .padding(.horizontal, 16)
            .padding(.vertical, 14)
            .background(phoneNumber.isEmpty ? Color.pochakSurfaceVar : Color.pochakPrimary)
            .clipShape(RoundedRectangle(cornerRadius: 12, style: .continuous))

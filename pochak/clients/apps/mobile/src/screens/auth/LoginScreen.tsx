...
const LoginScreen: React.FC = () => {
  ...
  const handleKakaoLogin = async () => {
    const kakaoRestKey = 'edc9e6bd81a7a4acf582dc0b5abe7a18';
  ...
  const handleGoogleLogin = async () => {
    const clientId = '314211860010-54tasp17q8b5qfq8648vu0jl4v3v5ojb.apps.googleusercontent.com';
  ...
  const handleNaverLogin = async () => {
    const clientId = 'MRf6icYP1IOnUr_RxdB_';

...
export const pochakBanners: PochakBanner[] = [
  {
    ...
    imageUrl: 'https://picsum.photos/seed/banner-1/1280/480',
  ...
  },
  {
    ...
    imageUrl: 'https://picsum.photos/seed/banner-2/1280/480',
  ...
  },
  {
    ...
    imageUrl: 'https://picsum.photos/seed/banner-3/1280/480',
...
export const pochakLiveContents: PochakContent[] = [
  {
    ...
    type: 'LIVE',
    status: 'LIVE',
    thumbnailUrl: 'https://picsum.photos/seed/live-1/640/360',
  ...
  },
  {
    ...
    type: 'LIVE',
    status: 'LIVE',
    thumbnailUrl: 'https://picsum.photos/seed/live-2/640/360',
    streamUrl: 'https://stream.example.com/live/002',
    duration: null,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
  ...
  },
  {
    ...
    type: 'LIVE',
    status: 'LIVE',
    thumbnailUrl: 'https://picsum.photos/seed/live-3/640/360',
    streamUrl: 'https://stream.example.com/live/003',
    duration: null,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
  ...
  },
  {
    ...
    type: 'LIVE',
    status: 'SCHEDULED',
    thumbnailUrl: 'https://picsum.photos/seed/live-4/640/360',
    streamUrl: null,
    duration: null,
    sport: '야구',
  ...
  },
  {
    ...
    type: 'LIVE',
    status: 'SCHEDULED',
    thumbnailUrl: 'https://picsum.photos/seed/live-5/640/360',
    streamUrl: null,
    duration: null,
    sport: '테니스',
  ...
  },
  {
    ...
    type: 'LIVE',
    status: 'SCHEDULED',
    thumbnailUrl: 'https://picsum.photos/seed/live-6/640/360',
    streamUrl: null,
    duration: null,
    sport: '풋살',
...
export const pochakVodContents: PochakContent[] = [
  {
    ...
    type: 'VOD',
    status: 'ENDED',
    thumbnailUrl: 'https://picsum.photos/seed/vod-1/640/360',
    streamUrl: 'https://vod.example.com/vod/001.mp4',
    duration: 332,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
    homeTeam: { name: '경기용인YSFC', shortName: '용인', logoColor: '#1565C0' },
  ...
  },
  {
    ...
    type: 'VOD',
    status: 'ENDED',
    thumbnailUrl: 'https://picsum.photos/seed/vod-2/640/360',
    streamUrl: 'https://vod.example.com/vod/002.mp4',
    duration: 6750,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
    homeTeam: { name: '인천남동FC', shortName: '인천', logoColor: '#0D47A1' },
  ...
  },
  {
    ...
    type: 'VOD',
    status: 'ENDED',
    thumbnailUrl: 'https://picsum.photos/seed/vod-3/640/360',
    streamUrl: 'https://vod.example.com/vod/003.mp4',
    duration: 6310,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
    homeTeam: { name: '서울강남FC', shortName: '강남', logoColor: '#4CAF50' },
  ...
  },
  {
    ...
    type: 'VOD',
    status: 'ENDED',
    thumbnailUrl: 'https://picsum.photos/seed/vod-4/640/360',
    streamUrl: 'https://vod.example.com/vod/004.mp4',
    duration: 298,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
  ...
  },
  {
    ...
    type: 'VOD',
    status: 'ENDED',
    thumbnailUrl: 'https://picsum.photos/seed/vod-5/640/360',
    streamUrl: 'https://vod.example.com/vod/005.mp4',
    duration: 1820,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
  ...
  },
  {
    ...
    type: 'VOD',
    status: 'ENDED',
    thumbnailUrl: 'https://picsum.photos/seed/vod-6/640/360',
    streamUrl: 'https://vod.example.com/vod/006.mp4',
    duration: 2400,
    sport: '축구',
    competition: '2025 화랑대기 유소년축구',
    homeTeam: { name: '포착 오리지널', shortName: '포착', logoColor: '#00C853' },
...
export const mockLiveContents: LiveContentItem[] = [
  {
    id: 'live-1',
    thumbnailUrl: 'https://picsum.photos/seed/mlive-1/400/240',
    teamHome: '경기용인YSFC',
    teamAway: '대구강북주니어',
    league: '2025 화랑대기',
    time: '전반 32분',
  ...
  {
    id: 'live-2',
    thumbnailUrl: 'https://picsum.photos/seed/mlive-2/400/240',
    teamHome: '인천남동FC',
    teamAway: '수원삼성블루윙즈',
    league: '2025 화랑대기',
    time: '후반 15분',
  ...
  {
    id: 'live-3',
    thumbnailUrl: 'https://picsum.photos/seed/mlive-3/400/240',
    teamHome: '서울강남FC',
    teamAway: '부산서면유소년',
    league: '2025 화랑대기',
    time: '전반 5분',
...
export const mockCompetitions: CompetitionItem[] = [
  {
    id: 'comp-1',
    thumbnailUrl: 'https://picsum.photos/seed/comp-1/560/280',
  ...
  {
    id: 'comp-2',
    thumbnailUrl: 'https://picsum.photos/seed/comp-2/560/280',
    title: '제5회 전국 리틀야구',
  ...
  {
    id: 'comp-3',
    thumbnailUrl: 'https://picsum.photos/seed/comp-3/560/280',
    title: '나이키 에어맥스 프리데이',
...
export const mockContentSections: ContentSection[] = [
  {
    ...
    items: [
      {
        id: 'vod-1',
        thumbnailUrl: 'https://picsum.photos/seed/vod-1/480/270',
        title: '경기용인 vs 대구강북 풀 하이라이트',
        badge: 'FREE' as const,
      ...
      {
        id: 'vod-2',
        thumbnailUrl: 'https://picsum.photos/seed/vod-2/480/270',
      ...
      {
        id: 'vod-3',
        thumbnailUrl: 'https://picsum.photos/seed/vod-3/480/270',
        title: '서울강남 vs 부산서면 베스트 플레이',
        badge: 'NEW' as const,
      ...
      {
        id: 'vod-4',
        thumbnailUrl: 'https://picsum.photos/seed/vod-4/480/270',
        title: '대구 vs 포항 풀 하이라이트',
        badge: 'FREE' as const,
        description: '화랑대기 유소년축구 | 10.18',
        viewCount: 21000,
  ...
  },
  {
    ...
    items: [
      {
        id: 'live-1',
        thumbnailUrl: 'https://picsum.photos/seed/live-1/320/180',
      ...
      {
        id: 'live-2',
        thumbnailUrl: 'https://picsum.photos/seed/live-2/320/180',
      ...
      {
        id: 'live-4',
        thumbnailUrl: 'https://picsum.photos/seed/live-4/320/180',
      ...
      {
        id: 'live-5',
        thumbnailUrl: 'https://picsum.photos/seed/live-5/320/180',
  ...
  },
  {
    ...
    items: [
      {
        id: 'clip-1',
        thumbnailUrl: 'https://picsum.photos/seed/clip-1/320/400',
      ...
      {
        id: 'clip-2',
        thumbnailUrl: 'https://picsum.photos/seed/clip-2/320/400',
      ...
      {
        id: 'clip-3',
        thumbnailUrl: 'https://picsum.photos/seed/clip-3/320/400',
      ...
      {
        id: 'clip-4',
        thumbnailUrl: 'https://picsum.photos/seed/clip-4/320/400',
        title: '결승골 세리머니 모음',
        viewCount: 76300,
        duration: '0:25',
      },
      {
        id: 'clip-5',
        thumbnailUrl: 'https://picsum.photos/seed/clip-5/320/400',
  ...
  },
  {
    ...
    items: [
      {
        id: 'vod-5',
        thumbnailUrl: 'https://picsum.photos/seed/vod-5/480/270',
        title: '감독의 하루 - 화랑대기 편',
        badge: 'NEW' as const,
      ...
      {
        id: 'vod-6',
        thumbnailUrl: 'https://picsum.photos/seed/vod-6/480/270',
        title: '루키 다이어리 시즌2',
        badge: 'FREE' as const,
  ...
  },
  {
    ...
    items: [
      {
        id: 'vod-5',
        thumbnailUrl: 'https://picsum.photos/seed/vod-5/320/180',
        title: '감독의 하루 - 화랑대기 편',
      ...
      {
        id: 'vod-6',
        thumbnailUrl: 'https://picsum.photos/seed/vod-6/320/180',
        title: '루키 다이어리 시즌2 EP.1',
      ...
      {
        id: 'clip-8',
        thumbnailUrl: 'https://picsum.photos/seed/clip-8/320/180',
...
export const popularClips: PopularClip[] = [
  { id: 'clip-1', title: '2025화랑대기 // U12 유망주 김포착 선수 드리블', thumbnail: 'https://picsum.photos/seed/clip-1/320/400' },
  { id: 'clip-2', title: '2025화랑대기 // 경기용인 수비수 신들린 태클', thumbnail: 'https://picsum.photos/seed/clip-2/320/400' },
  { id: 'clip-3', title: '2025화랑대기 // 대구강북 에이스 프리킥 골', thumbnail: 'https://picsum.photos/seed/clip-3/320/400' },
  { id: 'clip-4', title: '리틀야구 // 9회말 역전 홈런 명장면', thumbnail: 'https://picsum.photos/seed/clip-4/320/400' },
  { id: 'clip-5', title: '테니스대회 // 매치포인트 에이스 모음', thumbnail: 'https://picsum.photos/seed/clip-5/320/400' },
  { id: 'clip-6', title: '2025화랑대기 // 베스트 프리킥 TOP5', thumbnail: 'https://picsum.photos/seed/clip-6/320/400' },
];
...
export const defaultPlayerData: PlayerData = {
  ...
  likeCount: 3200,
  relatedVideos: [
    { id: 'vod-1', title: '경기용인 vs 대구강북 풀 하이라이트', thumbnail: 'https://picsum.photos/seed/vod-1/480/270', duration: '5:32' },
    { id: 'vod-2', title: '인천남동 vs 수원삼성 풀매치', thumbnail: 'https://picsum.photos/seed/vod-2/480/270', duration: '1:52:30' },
    { id: 'vod-3', title: '서울강남 vs 부산서면 베스트 플레이', thumbnail: 'https://picsum.photos/seed/vod-3/480/270', duration: '1:45:10' },
    { id: 'clip-1', title: 'U12 유망주 김포착 환상 드리블', thumbnail: 'https://picsum.photos/seed/clip-1/480/270', duration: '0:32' },
  ],
};

...
export default function SignUpPage() {
  ...
  const inputClass = "w-full px-3 py-2 bg-card2 border border-border rounded-lg text-white text-sm placeholder-muted/50 focus:ring-1 focus:ring-accent focus:border-accent outline-none transition-colors";
        ...
        <div className="bg-card rounded-2xl border border-border p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input value={form.tenantName} onChange={set('tenantName')} className={inputClass} placeholder="My QA Team" required />
            </div>
